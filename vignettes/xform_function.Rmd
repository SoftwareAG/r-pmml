...
The following R functions and operators are directly supported by `xform_function`. Their PMML equivalents are listed on the second line:
```{r,echo=FALSE}
...
## References
- [DMG PMML 4.4 specification](http://dmg.org/pmml/v4-4/GeneralStructure.html)